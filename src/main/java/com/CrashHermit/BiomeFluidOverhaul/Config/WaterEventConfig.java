...
import com.CrashHermit.BiomeFluidOverhaul.BiomeFluidOverhaul;
import com.CrashHermit.BiomeFluidOverhaul.proxy.CommonProxy;
import net.minecraftforge.common.config.Configuration;
import org.apache.logging.log4j.Level;

public class WaterEventConfig {
    ...
    public static void readConfig() {
        ...
        try {
            ...
            BiomeFluidOverhaul.logger.log(Level.ERROR, "Problem loading config file!", e1);
        } finally {
            if (cfg.hasChanged()) {
                cfg.save();
            }
